  ...
  return (
    <div className='text-center '>
        ...
        <p className='text-gray-400 mt-3 '>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur porro fugit earum sapiente deleniti, temporibus repellendus dicta architecto neque atque?
